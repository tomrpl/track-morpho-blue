...
export const whitelistedIds = [
  ...
  sdaiUsdcChainlinkAdaptiveCurveIRM965,
  wethUsdcChainlinkAdaptiveCurveIRM915,
  wethUsdcChainlinkAdaptiveCurveIRM860,
  wbtcUsdcChainlinkAdaptiveCurveIRM860,
];
